...
class Janela(Tk): ## Questão 01: (Complete o código que declara a classe)
    ...
    def action_Total_Vasco(self):
        ...
        return vasco_1 + vasco_2 + vasco_3
    ...
    def action_Bt_calc(self):
        ...
        total_flamengo = self.action_Total_Flamengo()
        total_vasco = self.action_Total_Vasco()
        
        self.__Et_total_flamengo.delete(0, END)
        self.__Et_total_vasco.delete(0, END)
        
        self.__Et_total_flamengo.insert(END, f"{total_flamengo:3.1f}")
        self.__Et_total_vasco.insert(END, f"{total_vasco:3.1f}")
